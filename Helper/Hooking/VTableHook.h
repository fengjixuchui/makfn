...
namespace Hook
{
	...
	public:
		...
		bool Initialize(void* Address)
		{
			...
			this->AllocatedVTable = reinterpret_cast<uintptr_t*>(reinterpret_cast<uintptr_t(__cdecl*)(uintptr_t, int, uintptr_t, void*)>(DoSpoofCall)(this->Size * 8, 0x10, SpoofCode, (void*)(Malloc)));
